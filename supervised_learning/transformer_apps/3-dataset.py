...
class Dataset:
    ...
    def __init__(self, batch_size, max_len):
        ...
        Args:
            batch_size: int representing the batch size for
            training/validation.
            max_len: int representing the maximum number of tokens allowed
    ...
    def filter_max_len(self, sentence_1, sentence_2):
        ...
        Args:
            sentence_1: sentence 1 (as: pt)
            sentence_2: sentence 2 (as: en)
